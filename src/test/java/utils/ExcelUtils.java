...
public class ExcelUtils {
	public static List<LinkedHashMap<String, String>> getData(String excelFileName, String sheetName)
	...
	public static List<String> dataWithParticularKeyValues(String someKey)
			throws EncryptedDocumentException, IOException {
